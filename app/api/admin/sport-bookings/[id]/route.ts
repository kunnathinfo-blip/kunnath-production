...
export async function PUT(
  ...
  try {
    ...
    const booking = await SportBooking.findById(id);
    ...
    console.error('Admin Update Sport Booking Error:', error);
...
export async function DELETE(
  ...
  try {
    ...
    const { id } = await params;
    const booking = await SportBooking.findByIdAndDelete(id);
    ...
    console.error('Admin Delete Sport Booking Error:', error);
